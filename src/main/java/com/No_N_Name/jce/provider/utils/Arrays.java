...
public final class Arrays {
    ...
    public static boolean constantTimeAreEqual(byte[] expected, byte[] supplied) {
        if (expected == supplied) {
            return true;
        } else if (expected != null && supplied != null) {
    ...
    public static byte[] clone(byte[] data, byte[] existing) {
        if (data == null) {
            return null;
        } else if (existing != null && existing.length == data.length) {
    ...
    public static byte[] concatenate(byte[] a, byte[] b, byte[] c) {
        if (a != null && b != null && c != null) {
            ...
            return b == null ? concatenate(a, c) : concatenate(a, b);
        }
    }
    ...
    public static byte[] concatenate(byte[] a, byte[] b, byte[] c, byte[] d) {
        if (a != null && b != null && c != null && d != null) {
            ...
            return b == null ? concatenate(a, c, d) : concatenate(b, c, d);
        }
    }

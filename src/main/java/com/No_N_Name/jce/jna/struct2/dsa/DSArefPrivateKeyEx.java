...
public class DSArefPrivateKeyEx extends Structure implements IDSArefPrivateKey {
	  public int bits;
	    ...
	    public static class ByValue extends DSArefPrivateKeyEx implements Structure.ByValue {
	        public ByValue() {
	        }
	    }

	    public static class ByReference extends DSArefPrivateKeyEx implements Structure.ByReference {
	        public ByReference() {
	        }
	    }
}
